...
model = TransformerModel(recipe_set_as_sequences.idx_to_token, embedding_dim, nhead, hidden_dim, nlayers, pad_idx, add_positioning_to_embeddings=False, dropout=dropout).to(device)
